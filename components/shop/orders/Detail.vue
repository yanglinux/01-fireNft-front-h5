...
export default {
  ...
  computed: {
    ...mapState({
      visible: (state) => state.shop.orders.modal.visible,
      data: (state) => state.shop.orders.modal.data,
      paidError: (state) => state.api.shop.orders.paid.error,
      paidMesseage: (state) => state.api.shop.orders.paid.message,
      paidLoading: (state) => state.api.shop.orders.paid.onFetch,
    }),
    items() {
  ...
  methods: {
    ...mapActions({
      ...
      paid: 'api/shop/orders/paid/request',
      getItems: 'api/shop/orders/list/request',
      toast: 'toast/add',
    }),
    closeModal() {
