...
export default {
  ...
  computed: {
    ...mapState({
      loading: (state) => state.api.shop.product.nft.cancel.onFetch,
      error: (state) => state.api.shop.product.nft.cancel.error,
      messeage: (state) => state.api.shop.product.nft.cancel.message,
    }),
  ...
  methods: {
    ...mapActions({
      request: 'api/shop/product/nft/cancel/request',
