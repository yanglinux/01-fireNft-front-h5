...
export default {
  ...
  computed: {
    ...mapState({
      loading: (state) => state.api.shop.setting.two_auth_delete.onFetch,
      error: (state) => state.api.shop.setting.two_auth_delete.error,
    }),
  },
  methods: {
    ...mapActions({
      removeTwoAuth: 'api/shop/setting/two_auth_delete/request',
