...
export default {
  ...
  computed: {
    ...mapState({
      loading: (state) => state.api.shop.setting.two_auth_update.onFetch,
      error: (state) => state.api.shop.setting.two_auth_update.error,
    }),
  },
  methods: {
    ...mapActions({
      updateTwoAuth: 'api/shop/setting/two_auth_update/request',
